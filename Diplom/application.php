<?php
    ...
    function addApplication($name,$phone,$age,$con){
        $applicationQeury = $con->prepare('INSERT INTO `impro`( `name`, `phone`, `age`) VALUES (:name,:phone,:age)');
        $applicationQeury->execute(['name' => $name,'phone' => $phone, 'age' => $age]);
        return ["status" => true ,"message" =>"Спасибо за обращение. Мы свяжемся с Вами в ближайшее время.","id" =>$con->lastInsertId()];
    }
